...
pub const MODULE: &str = concatcp!(MAGENTA, BOLD, UNDERLINE);
pub const DIRECTIVE: &str = concatcp!(YELLOW, BOLD);
pub const KIND: &str = concatcp!(BLUE, BOLD);
pub const DIMENSION: &str = concatcp!(BLUE);
pub const PUNCT: &str = concatcp!(CYAN);
pub const DELIM: &str = concatcp!(CYAN);
pub const KEYWORD: &str = concatcp!(GREEN);
pub const OPERATOR: &str = concatcp!(RED);
