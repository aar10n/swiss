use super::{coerce, Context, Conversion, Dim, DimExpr, Exception, Number, Ty, Value};
...
impl Quantity {
    ...
    pub fn safe_add(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<Quantity, Exception> {
    ...
    pub fn safe_sub(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<Quantity, Exception> {
        // let (a, b) = coerce::binary_pair(ctx, a, b);
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_mul(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<Quantity, Exception> {
        // let (a, b) = coerce::binary_pair(ctx, a, b);
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_div(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<Quantity, Exception> {
        // let (a, b) = coerce::binary_pair(ctx, a, b);
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_mod(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<Quantity, Exception> {
        // let (a, b) = coerce::binary_pair(ctx, a, b);
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_bit_not(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
    ...
    pub fn safe_bit_or(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<Quantity, Exception> {
        // let (a, b) = coerce::binary_pair(ctx, a, b);
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_eq(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<bool, Exception> {
        let (a, b) = coerce::binary_pair(ctx, a, b);
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_lt(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<bool, Exception> {
        // let (a, b) = coerce::binary_pair(ctx, a, b);
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_le(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<bool, Exception> {
        // let (a, b) = coerce::binary_pair(ctx, a, b);
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_gt(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<bool, Exception> {
        // let (a, b) = coerce::binary_pair(ctx, a, b);
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_ge(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<bool, Exception> {
        // let (a, b) = coerce::binary_pair(ctx, a, b);
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_ln(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, a_dim) = a.into_tuple();
        let number = Number::safe_ln(ctx, a)?;
        Ok(Quantity::new(number, a_dim))
    }

    pub fn safe_log2(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, a_dim) = a.into_tuple();
        let number = Number::safe_log2(ctx, a)?;
        Ok(Quantity::new(number, a_dim))
    }

    pub fn safe_log10(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, a_dim) = a.into_tuple();
    ...
    pub fn safe_pow(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<Quantity, Exception> {
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_sqrt(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, a_dim) = a.into_tuple();
        let number = Number::safe_sqrt(ctx, a)?;
        Ok(Quantity::new(number, a_dim))
    }

    pub fn safe_cbrt(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, a_dim) = a.into_tuple();
    ...
    pub fn safe_floor(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (number, dim) = a.into_tuple();
        let number = Number::safe_floor(ctx, number)?;
        Ok(Quantity::new(number, dim))
    }

    pub fn safe_ceil(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (number, dim) = a.into_tuple();
        let number = Number::safe_ceil(ctx, number)?;
        Ok(Quantity::new(number, dim))
    }

    pub fn safe_round(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (number, dim) = a.into_tuple();
    ...
    pub fn safe_sin(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _) = a.into_tuple();
        let number = Number::safe_sin(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_cos(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _) = a.into_tuple();
        let number = Number::safe_cos(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_tan(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _) = a.into_tuple();
        let number = Number::safe_tan(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_asin(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _a_dim) = a.into_tuple();
        let number = Number::safe_asin(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_acos(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _a_dim) = a.into_tuple();
        let number = Number::safe_acos(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_atan(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _a_dim) = a.into_tuple();
        let number = Number::safe_atan(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_atan2(ctx: &mut Context, a: Quantity, b: Quantity) -> Result<Quantity, Exception> {
        let (a, a_dim) = a.into_tuple();
        let (b, b_dim) = b.into_tuple();
    ...
    pub fn safe_sinh(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _) = a.into_tuple();
        let number = Number::safe_sinh(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_cosh(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _) = a.into_tuple();
        let number = Number::safe_cosh(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_tanh(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _) = a.into_tuple();
        let number = Number::safe_tanh(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_asinh(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _a_dim) = a.into_tuple();
        let number = Number::safe_asinh(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_acosh(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _a_dim) = a.into_tuple();
        let number = Number::safe_acosh(ctx, a)?;
        Ok(Quantity::new(number, Dim::none()))
    }

    pub fn safe_atanh(ctx: &mut Context, a: Quantity) -> Result<Quantity, Exception> {
        let (a, _a_dim) = a.into_tuple();
